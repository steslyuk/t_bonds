...
RISK_DESC = {
    "cons": "ОФЗ + первый эшелон · дефолты крайне редки · доходность ниже",
    "mod":  "первый и средний эшелон · умеренный кредитный риск",
    "agg":  "включая ВДО · выше доходность · ~1-2 дефолта на 20 бумаг за несколько лет",
}
